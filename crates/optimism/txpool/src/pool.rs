...
use reth_transaction_pool::{
    ...
    PoolUpdateKind, PropagatedTransactions, TransactionEvents, TransactionListenerKind,
    ...
    P::Transaction: Transaction,
{
    ...
    delegate!(async fn add_transaction(&self, origin: TransactionOrigin, transaction: Self::Transaction) -> PoolResult<AddedTransactionOutcome>);
    delegate!(async fn add_transactions(&self, origin: TransactionOrigin, transactions: Vec<Self::Transaction>) -> Vec<PoolResult<AddedTransactionOutcome>>);
    ...
    delegate!(fn unique_senders(&self) -> HashSet<Address>);
